...
with instance_create_layer(x,y,"Game_Objects",o_bit) {sprite_index = s_enemy_robot_air_small_part1; image_index = 0; image_speed = 0; speed = random_range(1, 3); direction = random_range(0, 359)}
with instance_create_layer(x,y,"Game_Objects",o_bit) {sprite_index = s_enemy_robot_air_small_part2; image_index = 0; image_speed = 0; speed = random_range(1, 3); direction = random_range(0, 359)}
...
with instance_create_layer(x,y,"Game_Objects",o_bit) {sprite_index = s_enemy_robot_air_small_part8; image_index = 0; image_speed = 0; speed = random_range(1, 3); direction = random_range(0, 359)}
