if slot == 1{
    if object_get_parent(gun_slot_1.object_index) == o_gun_energyP or gun_slot_1.total_ammo >= gun_slot_1.ammo_max{
        ...
        change = 4 * gun_slot_1.clip_size + lost;
...
exit;
    ...
    if object_get_parent(gun_slot_2.object_index) == o_gun_energyP or gun_slot_2.total_ammo >= gun_slot_2.ammo_max{
        exit;
    }
        ...
        change = 4 * gun_slot_2.clip_size + lost;
        o_player_control.dialouge[1] = 200;
