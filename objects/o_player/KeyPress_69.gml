if collision_rectangle(x, y, x + 48, y + 72, gun_ground, true, false){
    if slot == 1{
        if (gun_slot_1.object_index != gun_ground.object_index and gun_slot_2.object_index != gun_ground.object_index) and object_get_parent(gun_ground.object_index) != o_gun_energyP{
            with gun_slot_1{
                state = "Ground";
        ...
        else if (gun_slot_2.object_index != gun_ground.object_index) and object_get_parent(gun_ground.object_index) == o_gun_energyP{
            with gun_slot_1{
                state = "Ground";
                speed = 0;
                image_yscale = other.image_yscale;
        ...
        else if (gun_slot_1.object_index != gun_ground.object_index) and object_get_parent(gun_ground.object_index) == o_gun_energyP{
            with gun_slot_2{
                state = "Ground";
                speed = 0;
                image_yscale = other.image_yscale;
